  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        {/* Brand */}
        <div style={{ color: '#1a4a28', fontSize: '13px', letterSpacing: '4px', marginBottom: '20px', display: 'flex' }}>
          BANKRSYNTH INTELLIGENCE REPORT
        </div>
        ...
        <div style={{
          ...
          <div style={{ color: '#1a4a28', fontSize: '11px', letterSpacing: '2px', display: 'flex' }}>
            Generated by BankrSynth · AI Intelligence for Base
          </div>
