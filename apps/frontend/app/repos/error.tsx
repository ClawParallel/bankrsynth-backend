'use client'
export default function ReposError({ error, reset }: { error: Error; reset: () => void }) {
  return (
    <main className="page-wrapper" style={{ padding: '80px 16px', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', fontFamily: 'var(--font-mono)', gap: '12px' }}>
      <div style={{ fontSize: '9px', letterSpacing: '0.3em', color: 'rgba(255,26,60,0.5)' }}>// REPOS ERROR</div>
